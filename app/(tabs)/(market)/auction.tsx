	...
	return (
		<>
			...
			<Modal uniqueId={ 'auction_filter_category' }>
				<View style={ {
					gap: 8, paddingBottom: 15,
					backgroundColor: colorScheme === 'dark' ? '#1E1E1E' : '#FFFFFF',
				} }>
					<ItemButton checked={ filteredCategory === '배송비 포함' } onClick={ () => setFilteredCategory('배송비 포함') }>배송비
						포함</ItemButton>
					<ItemButton checked={ filteredCategory === '배송비 별도' } onClick={ () => setFilteredCategory('배송비 별도') }>배송비
						별도</ItemButton>
				</View>
			</Modal>
